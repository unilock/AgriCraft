...
public class PlantsDatagen {
	...
	public static void registerPlants(BootstrapContext<AgriPlant> context) {
		...
		agricraft(context, "nethereed", new AgriPlant.Builder().stages16().chances(0.15, 0.015, 0.025).products(AgriProduct.builder().item("agricraft:netherite_sliver").count(1, 1, 0.25).build()).harvest(0).requirement(AgriRequirement.builder().humidity(DRY, EQUAL, 0.2).acidity(SLIGHTLY_ALKALINE, EQUAL, 0.2).nutrients(LOW, EQUAL, 0.2).biomes(ResourceLocation.parse("minecraft:the_nether")).seasons(SUMMER).blocks(AgriBlockCondition.builder().tag("c:ores/netherite_scrap").build()).fluid(AgriFluidCondition.builder().fluid("minecraft:lava").build()).build()).modifiers(new AgriPlantModifierInfo(ResourceLocation.parse("agricraft:thorns")), new AgriPlantModifierInfo(ResourceLocation.parse("agricraft:bushy")), new AgriPlantModifierInfo(ResourceLocation.parse("agricraft:burn"))).build());
		...
		agricraft(context, "nitor_wart", new AgriPlant.Builder().stages16().chances(0.6, 0.025, 0.1).products(AgriProduct.builder().tag("c:dusts/glowstone").count(1, 4, 0.9).build()).harvest(3).requirement(AgriRequirement.builder().humidity(ARID, EQUAL, 0.15).acidity(NEUTRAL, EQUAL, 0.2).nutrients(VERY_HIGH, EQUAL_OR_HIGHER, 0.1).blocks(AgriBlockCondition.builder().item("minecraft:glowstone").build()).build()).modifiers(new AgriPlantModifierInfo(ResourceLocation.parse("agricraft:brightness"))).build());
