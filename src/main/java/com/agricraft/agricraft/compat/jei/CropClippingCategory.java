...
public class CropClippingCategory implements IRecipeCategory<AgriPlant> {
	...
	public static final IDrawable ICON = AgriCraftJeiClient.createDrawable(ResourceLocation.fromNamespaceAndPath(AgriApi.MOD_ID, "textures/item/clipper.png"), 0, 0, 16, 16, 16, 16);
